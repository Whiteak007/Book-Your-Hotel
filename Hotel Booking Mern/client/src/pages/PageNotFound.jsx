...
const PageNotFound = () => {
    return (
        <>
            <div class="flex flex-col items-center justify-center text-sm max-md:px-4 h-screen">
                ...
                <div class="flex items-center gap-4 mt-6">
                    <a href="http://localhost:5173/" class="bg-gray-800 px-7 py-2.5 text-white rounded-md active:scale-95 transition-all">
                        Return Home
                    </a>
